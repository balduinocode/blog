...
**Objetivo: EQUILÍBRIO.** Agem como um freio, trazendo a variável de volta para uma faixa desejável.***Exemplo:*** Termostato & sistema de aquecimento.
...
**Objetivo: AMPLIFICAÇÃO.** Agem como um acelerador, impulsionando o sistema/processo específico para longe de seu ponto de partida.***Exemplo:*** Popularidade das trends da moda e ciclos envolvidos na pobreza
...
**Exemplo 2:**O ato de pagar resgate a sequestradores ilustra perfeitamente essa lente de análise.• **Problema Imediato (Curto Prazo):** Alguém foi sequestrado, e a demanda é por dinheiro para libertá-lo. Pagar o resgate salva uma vida e resolve o problema _agora_.• **Feedback Criado (Longo Prazo):** Sua resposta (pagar o resgate) comunica aos sequestradores que você cede às suas demandas. Isso cria um **incentivo** para eles sequestrarem novamente (ciclo reforçador) e sinaliza a outros aspirantes a sequestradores que o crime é lucrativo.
...
- **Não olhe apenas para o todo (pensamento binário)**
    ...
    "Pensando nas margens, o mais importante, significa olhar para os problemas não de forma inteira/total, como se fosse tudo ou nada, mas em incrementos/partes: vendo o comportamento como um monte de decisões sobre quando fazer um pouco menos em uma direção e fazer um pouco mais em outra direção."    - Ward Farnsworth

*Exemplo:* fazer as pessoas pararem de beber refrigerantePENSAMENTO BINÁRIO: Ou elas consomem ou não consomemPENSAMENTO MARGINAL: Observa-se onde pode-se influenciar o comportamento em diferentes aspectos
...
O famoso artista Wassily Kandinsky nos dá um exemplo perfeito disso:Kandinsky criou uma de suas obras mais famosas, a pintura chamada _Painting with White Border_.
