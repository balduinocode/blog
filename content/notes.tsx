...
export const notes: Note[] = [
  {
    "slug": "python",
    "title": "Por que escolhi Python?",
    "date": "2026-02-4",
    "excerpt": "",
    "content": "<p>Quando li o livro \"A sabedoria de Charlie Munger\", encontrei nele um framework de pensamento valiosíssimo. Uso-o para questões pragmáticas, como qual linguagem de programação aprender. Esse framework chama-se Latticework of Mental Models. Não irei adentrar no conceito, pois já fiz um post explicando-o. Através dele, escolhi a linguagem de programação na qual me debruçaria.</p>\n<p>Eu não buscava uma ferramenta qualquer, mas uma que lidasse bem com a mutabilidade do mundo,e principalmente da tecnologia. Usei então alguns modelos mentais como:</p>\n<ul><li>Área de Superfície: Qual linguagem possui um maior oceano para navegar(criar)?</li><li>Canivete Suíço: Qual linguagem seria capaz de fazer todas as coisas razoavelmente bem?</li><li>Princípio de Pareto: Qual linguagem me fornece 80% do resultado buscado com 20% de esforço?</li><li>Efeito Lindy: Qual linguagem tem mais potencial de antifragilidade?</li></ul>\n<p>Dentro desses parâmetros, Python foi o campeão com folga. Com a difusão de acesso da Inteligência Artificial, nem poderia ter dúvidas. Afinal eu precisava de adaptabilidade estratégica. Posso criar facilmente qualquer coisa com Python: uma automação, um site, um jogo, um processo de web scraping, etc.</p>"
  },
  {
    "slug": "filmes",
  ...
  },
  {
    ...
    "date": "Fevereiro 2026",
    "excerpt": "",
    "content": "<p>Rolando o feed do Youtube, deparei-me com um vídeo cuja thumb tinha inscrito \"O que aprendi com esse anime\". Cliquei e na descrição vi que era um anime chamado 'Golden Boy'. Nem pensei em assistir ao vídeo. Não sei porquê, mas fui imediatamente atrás de assistir ao anime. Eu queria ver o que EU poderia aprender com ele. Afinal, aprender é  muito bom, não é mesmo?</p>\n<p>Confesso, é um anime muito engraçado pelo exagero e sexualização banal. Ri muito. No entanto, aprendi algo. A vontade é uma força monstruosa. Nunca tinha entendido essa frase de um professor meu. Até encontrar 'Golden Boy', pois uma imagem vale mais que mil palavras. Kintaro não é gênio, mas tem uma virtude de estar apaixonado imprudentemente pela vida (e pelas mulheres) que é contagiante. E contagiou-me. Ele age como uma criança descobrindo o mundo. Talvez esse seja o ponto. Recentemente assisti a série The Young Pope e lembro bem de uma fala:</p>\n<blockquote>Crianças pintam o futuro com cores que a realidade desconhece.</blockquote>\n<p>E Kintaro faz isso muito bem. Principalmente com as pessoas com quem se relaciona. Elas ganham um pouco desse brilho nos olhos que ele tem por demais. Ele está sempre a dizer: \"Vivendo e aprendendo\". Clichê? Talvez. Mas acho que não precisa ir muito longe para ver a sabedoria milenar por trás dessa frase. E o mais interessante: a capacidade de Kintaro de estar apaixonado pela vida o leva a tomar a decisão sempre por aquilo que é certo e não por aquilo que convém a ele. Do amor nasce a moral e a capacidade de criar um senso identidade própria. Somente as pessoas que tomam os riscos da vida e seguem pelo que é certo a ser feito, sem nenhum pensamento de preservar-se, assim como Kintaro faz, somente elas podem ter o elemento mais aclamado e menos possuído pelas pessoas: personalidade. E para fazer isso, tem que estar embriagado. De quê? Baudelaire nos diz:</p>\n<blockquote>\"É a única questão. Para não sentir o horrível fardo do Tempo que vos esmaga os ombros e vos verga para a terra, embriagai-vos; embriagai-vos sem cessar! De vinho, de poesia ou de virtude, a vosso gosto. Mas embriagai-vos.\"</blockquote>"
  },
  {
    "slug": "amador",
